...
def get_dataloaders(conf):
    ...
    height = conf['crop_image_height']
    width = conf['crop_image_width']
    train_loader_a = my_motion_data_loader_folder(os.path.join(conf['data_root'], 'train_motion'), batch_size, True,
                                            new_size_a, height, width, num_workers, True)
    train_loader_b = my_motion_data_loader_folder2(os.path.join(conf['data_root'], 'train_gt'), batch_size, True,
                                            new_size_b, height, width, num_workers, True)
    test_loader_a = my_motion_data_loader_folder(os.path.join(conf['data_root'], 'val_motion'), batch_size, False,
                                           new_size_a, new_size_a, new_size_a, num_workers, True)
    test_loader_b = my_motion_data_loader_folder2(os.path.join(conf['data_root'], 'val_gt'), batch_size, False,
                                           new_size_b, new_size_b, new_size_b, num_workers, True)
    # train_loader_a = my_motion_data_loader_folder(os.path.join(conf['data_root'], 'di5pishuju'), batch_size, True,
    #                                         new_size_a, height, width, num_workers, True)
    # train_loader_b = my_motion_data_loader_folder2(os.path.join(conf['data_root'], 'train_gt'), batch_size, True,
    #                                         new_size_b, height, width, num_workers, True)
    # test_loader_a = my_motion_data_loader_folder(os.path.join(conf['data_root'], 'val_motion'), batch_size, False,
