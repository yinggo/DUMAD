...
if __name__ == "__main__":
    file1 = '/home/user/data4/chongxin/LIR-for-Unsupervised-IR/dataset/moni_motion/Celeba_A/HUANG_BIN-IMG-0002-00001.png'
    file2 = '/home/user/data4/chongxin/LIR-for-Unsupervised-IR/dataset/moni_motion/Celeba_B/HUANG_BIN-IMG-0002-00001.png'
    main(file1, file2)
    # testPIL(file1, file2)
